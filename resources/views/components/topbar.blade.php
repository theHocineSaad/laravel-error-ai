...
<div class="flex items-center justify-between" x-data="{
    ...
    <div class="flex">
        <button x-cloak @class([
            'text-sm rounded-l-md border px-3 h-8 flex items-center gap-2 transition-colors duration-200 ease-in-out cursor-pointer shadow-xs',
        ...
        <x-laravel-exceptions-renderer::ask-ai-button :markdown="$markdown" />
    </div>
</div>
